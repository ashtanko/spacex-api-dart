...
class _StarlinkApi implements StarlinkApi {
  _StarlinkApi(this._dio, {this.baseUrl}) {
  ...
  Future<List<StarlinkModel>> getStarlinkList() async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<StarlinkModel>>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/starlink',
  ...
  Future<StarlinkModel> getStarlink(id) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<StarlinkModel>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/starlink/${id}',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<ApiPaginatedList<StarlinkModel>> queryStarlinkList(query) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiPaginatedList<StarlinkModel>>(
            Options(method: 'POST', headers: _headers, extra: _extra)
                .compose(_dio.options, '/starlink/query',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<ApiPaginatedList<StarlinkFullModel>> queryFullStarlinkList(
    ...
    _data.addAll(query.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiPaginatedList<StarlinkFullModel>>(
            Options(method: 'POST', headers: _headers, extra: _extra)
                .compose(_dio.options, '/starlink/query',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));

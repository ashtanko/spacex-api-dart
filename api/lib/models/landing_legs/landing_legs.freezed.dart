...
/// @nodoc
class _$LandingLegsTearOff {
  const _$LandingLegsTearOff();

  _LandingLegs call(
      {@JsonKey(name: 'number') num number = 0,
  ...
  LandingLegs fromJson(Map<String, Object?> json) {
    return LandingLegs.fromJson(json);
  }
}

/// @nodoc
const $LandingLegs = _$LandingLegsTearOff();
...
abstract class _LandingLegs extends LandingLegs {
  const factory _LandingLegs(
      {@JsonKey(name: 'number') num number,
      @JsonKey(name: 'material') String? material}) = _$_LandingLegs;

...
LaunchSimple _$LaunchSimpleFromJson(Map<String, dynamic> json) {
  return _LaunchSimple.fromJson(json);
}

/// @nodoc
mixin _$LaunchSimple {
  @JsonKey(name: 'id')
  String get id => throw _privateConstructorUsedError;
  bool get tbd => throw _privateConstructorUsedError;
  @JsonKey(name: 'auto_update')
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $LaunchSimpleCopyWith<LaunchSimple> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LaunchSimpleCopyWith<$Res> {
  factory $LaunchSimpleCopyWith(
          LaunchSimple value, $Res Function(LaunchSimple) then) =
      _$LaunchSimpleCopyWithImpl<$Res>;
  $Res call(
...
/// @nodoc
class _$LaunchSimpleCopyWithImpl<$Res> implements $LaunchSimpleCopyWith<$Res> {
  _$LaunchSimpleCopyWithImpl(this._value, this._then);

  final LaunchSimple _value;
  // ignore: unused_field
  final $Res Function(LaunchSimple) _then;
...
/// @nodoc
abstract class _$$_LaunchSimpleCopyWith<$Res>
    implements $LaunchSimpleCopyWith<$Res> {
  factory _$$_LaunchSimpleCopyWith(
          _$_LaunchSimple value, $Res Function(_$_LaunchSimple) then) =
      __$$_LaunchSimpleCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'id') String id,
      bool tbd,
...
/// @nodoc
class __$$_LaunchSimpleCopyWithImpl<$Res>
    extends _$LaunchSimpleCopyWithImpl<$Res>
    implements _$$_LaunchSimpleCopyWith<$Res> {
  __$$_LaunchSimpleCopyWithImpl(
      _$_LaunchSimple _value, $Res Function(_$_LaunchSimple) _then)
      : super(_value, (v) => _then(v as _$_LaunchSimple));

  @override
  _$_LaunchSimple get _value => super._value as _$_LaunchSimple;
...
/// @nodoc
@JsonSerializable()
class _$_LaunchSimple extends _LaunchSimple {
  const _$_LaunchSimple(
      ...
      @JsonKey(name: 'crew') final List<String> crew = const <String>[],
      @JsonKey(name: 'details') this.details = '',
      @JsonKey(name: 'failures') final List<LaunchFailure> failures = const [],
      @JsonKey(name: 'success') this.success = false,
      @JsonKey(name: 'rocket') this.rocket = '',
  ...
  factory _$_LaunchSimple.fromJson(Map<String, dynamic> json) =>
      _$$_LaunchSimpleFromJson(json);
...
//@JsonKey(name: 'ships') @Default([]) List<Ship> ships,
  ...
  @override
  String toString() {
    return 'LaunchSimple(id: $id, tbd: $tbd, autoUpdate: $autoUpdate, cores: $cores, upcoming: $upcoming, datePrecision: $datePrecision, dateLocal: $dateLocal, dateUnix: $dateUnix, dateUtc: $dateUtc, name: $name, flightNumber: $flightNumber, launchpad: $launchpad, payloads: $payloads, capsules: $capsules, crew: $crew, details: $details, failures: $failures, success: $success, rocket: $rocket, window: $window, net: $net, staticFireDateUnix: $staticFireDateUnix, staticFireDateUtc: $staticFireDateUtc, links: $links, fairings: $fairings)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$$_LaunchSimpleCopyWith<_$_LaunchSimple> get copyWith =>
      __$$_LaunchSimpleCopyWithImpl<_$_LaunchSimple>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_LaunchSimpleToJson(
      this,
    );
  }
}

abstract class _LaunchSimple extends LaunchSimple {
  const factory _LaunchSimple(
      ...
      @JsonKey(name: 'static_fire_date_utc') final String staticFireDateUtc,
      @JsonKey(name: 'links') final LaunchLinks? links,
      @JsonKey(name: 'fairings') final Fairings? fairings}) = _$_LaunchSimple;
  const _LaunchSimple._() : super._();

  factory _LaunchSimple.fromJson(Map<String, dynamic> json) =
      _$_LaunchSimple.fromJson;

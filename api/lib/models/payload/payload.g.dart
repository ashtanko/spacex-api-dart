...
_$_Payload _$$_PayloadFromJson(Map<String, dynamic> json) => _$_Payload(
      ...
      dragon: json['dragon'] == null
          ? null
          : PayloadDragon.fromJson(json['dragon'] as Map<String, dynamic>),
...
_$_FullPayload _$$_FullPayloadFromJson(Map<String, dynamic> json) =>
    _$_FullPayload(
      id: json['id'] as String,
      dragon: json['dragon'] == null
          ? null
...
Map<String, dynamic> _$$_FullPayloadToJson(_$_FullPayload instance) =>
    <String, dynamic>{
      'id': instance.id,
      'dragon': instance.dragon?.toJson(),
      'name': instance.name,
...
_$_PayloadDragon _$$_PayloadDragonFromJson(Map<String, dynamic> json) =>
    _$_PayloadDragon(
...
Map<String, dynamic> _$$_PayloadDragonToJson(_$_PayloadDragon instance) =>
    <String, dynamic>{

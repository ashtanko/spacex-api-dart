...
/// @nodoc
abstract class $RoadsterVehicleCopyWith<$Res> {
...
/// @nodoc
class _$RoadsterVehicleCopyWithImpl<$Res>
...
/// @nodoc
@JsonSerializable()
class _$_RoadsterVehicle extends _RoadsterVehicle {
  const _$_RoadsterVehicle(
      {required this.id,
      this.details,
      this.video,
      this.wikipedia,
...
/// @nodoc
abstract class $RocketVehicleCopyWith<$Res> {
...
/// @nodoc
class _$RocketVehicleCopyWithImpl<$Res>
...
/// @nodoc
@JsonSerializable()
class _$_RocketVehicle extends _RocketVehicle {
  const _$_RocketVehicle(
      {required this.id,
      this.description = '',
  ...
  @override
  String toString() {
    return 'RocketVehicle(id: $id, description: $description, wikipedia: $wikipedia, company: $company, country: $country, firstFlight: $firstFlight, successRatePct: $successRatePct, costPerLaunch: $costPerLaunch, boosters: $boosters, stages: $stages, isActive: $isActive, type: $type, name: $name, images: $images, payloadWeights: $payloadWeights, landingLegs: $landingLegs, engines: $engines)';
  }
...
mixin _$SecondStage {
  ...
  dynamic get payloads => throw _privateConstructorUsedError;
...
class _$_SecondStage extends _SecondStage {
  const _$_SecondStage(
      ...
      this.reusable = false,
      this.engines = 0,
      @JsonKey(name: 'fuel_amount_tons') this.fuelAmountTons = 0,
...
abstract class _SecondStage extends SecondStage {
  const factory _SecondStage(
      ...
      @JsonKey(name: 'burn_time_sec') final num burnTimeSec}) = _$_SecondStage;
...
/// @nodoc
abstract class $ShipVehicleCopyWith<$Res> {
...
/// @nodoc
class _$ShipVehicleCopyWithImpl<$Res> implements $ShipVehicleCopyWith<$Res> {
...
/// @nodoc
abstract class $DragonVehicleCopyWith<$Res> {
...
/// @nodoc
class _$DragonVehicleCopyWithImpl<$Res>
  ...
  @override
  $DiameterCopyWith<$Res> get heightWTrunk {
    return $DiameterCopyWith<$Res>(_value.heightWTrunk, (value) {
...
/// @nodoc
@JsonSerializable()
class _$_DragonVehicle extends _DragonVehicle {
  const _$_DragonVehicle(
      {required this.id,
      this.description = '',
      ...
      @JsonKey(name: 'sidewall_angle_deg') this.sidewallAngleDeg = 15,
      @JsonKey(name: 'crew_capacity') this.crewCapacity = 0,
      @JsonKey(name: 'active') this.isActive = false,

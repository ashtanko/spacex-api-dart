...
abstract class $CapsuleFullModelCopyWith<$Res> {
  factory $CapsuleFullModelCopyWith(
      ...
      _$CapsuleFullModelCopyWithImpl<$Res>;
...
/// @nodoc
class _$CapsuleFullModelCopyWithImpl<$Res>
    implements $CapsuleFullModelCopyWith<$Res> {
  _$CapsuleFullModelCopyWithImpl(this._value, this._then);

  final CapsuleFullModel _value;

  // ignore: unused_field
  final $Res Function(CapsuleFullModel) _then;
...
class __$$_CapsuleFullModelCopyWithImpl<$Res>
    extends _$CapsuleFullModelCopyWithImpl<$Res>
  ...
  __$$_CapsuleFullModelCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_CapsuleFullModel));

  @override
  _$_CapsuleFullModel get _value => super._value as _$_CapsuleFullModel;
...
class _$_CapsuleFullModel extends _CapsuleFullModel {
  const _$_CapsuleFullModel(
      ...
      @JsonKey(name: 'launches') final List<Launch> launches = const <Launch>[],
      this.serial = '',
      this.status = '',
      this.type = '',
...
abstract class _CapsuleFullModel extends CapsuleFullModel {
  const factory _CapsuleFullModel(
      ...
      @JsonKey(name: 'launches') final List<Launch> launches,
      final String serial,
      final String status,
      final String type,

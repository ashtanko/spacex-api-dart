...
/// @nodoc
abstract class $QueryFullShipsCopyWith<$Res> {
...
/// @nodoc
class _$QueryFullShipsCopyWithImpl<$Res>
...
class _$_QueryFullShips extends _QueryFullShips {
  ...
  @override
  String toString() {
    return 'QueryFullShips(docs: $docs, totalDocs: $totalDocs, offset: $offset, limit: $limit, totalPages: $totalPages, page: $page, pagingCounter: $pagingCounter, hasPrevPage: $hasPrevPage, hasNextPage: $hasNextPage, prevPage: $prevPage, nextPage: $nextPage)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_QueryFullShipsToJson(this);
  }
}

...
/// @nodoc
abstract class $LaunchpadDetailsCopyWith<$Res> {
...
/// @nodoc
class _$LaunchpadDetailsCopyWithImpl<$Res>
...
/// @nodoc
@JsonSerializable()
class _$_LaunchpadDetails extends _LaunchpadDetails {
  const _$_LaunchpadDetails(
      {this.name,
      this.fullName,
      this.locality,
      this.region,
  ...
  factory _$_LaunchpadDetails.fromJson(Map<String, dynamic> json) =>
      _$$_LaunchpadDetailsFromJson(json);
  ...
  @override
  String toString() {
    return 'LaunchpadDetails(name: $name, fullName: $fullName, locality: $locality, region: $region, latitude: $latitude, longitude: $longitude, launchAttempts: $launchAttempts, launchSuccesses: $launchSuccesses, status: $status, details: $details, imageUrl: $imageUrl, id: $id)';
  }
